...
\begin{table}
  \begin{tabular}{l|r|r|r|r|r}
    ...
    \hline
  \end{tabular}
  \caption{Python tool results over all projects (old).}
...
\begin{table}
  \begin{tabular}{l|r|r|r|r|r}
    ...
    \hline
    \hline
    Pylint & 11.87 & 4.00 & 0.20 & 0.19 & 0.02 \\
    Clean (3) & - & - & 0.09 & 0.11 & - \\
    \hline
    pyflakes & 1.52 & 0.00 & 0.08 & 0.06 & 0.05 \\
    Clean (15) & - & - & 0.09 & 0.08 & - \\
    \hline
    MyPy & 3.00 & 3.00 & 0.05 & 0.03 &  0.02 \\
    Clean (3) & - & - & 0.03 & 0.01 & - \\
    \hline
  \end{tabular}
  \caption{Python tool results over all projects (new).}
  \label{tab:scorepython}
\end{table}


Figure \ref{fig:pythonvenn} shows the mutants killed by the Python analysis tools, and Table \ref{tab:scorepython} provides numeric results for projects and clean projects, respectively.  At the project level, Pylint was better than pyflakes and PyChecker for 22 of 25 projects each by raw score, and better by ratio for 23 and 22 projects, respectively.  PyChecker was better than pyflakes for 15 projects, by both raw and ratio measures.  Standard deviations in mutation scores were high for Python:  0.15 for Pylint, 0.06 for pyflakes, and 0.27 for PyChecker.
