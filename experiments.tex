...
\item {\bf RQ4:}  Are mutation scores for clean programs better than those for programs for which tools report findings before the program is mutated?
...
\item {\bf RQ6:}  How easy is it identify low-hanging fruit for improving tools \emph{without} prioritization to remove conceptually redundant mutants?
  \end{itemize}
